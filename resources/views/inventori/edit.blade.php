                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="notelp"
                                                value="{{ old('notelp', $penyewa->notelp) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" placeholder="">{{ old('alamat', $penyewa->alamat) }}</textarea>
                                            @error('alamat')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>

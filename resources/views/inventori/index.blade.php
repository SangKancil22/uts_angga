        ...
        <div class="container-xl ">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('penyewa.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        <a href="{{ route('penyewa.create') }}" class="btn btn-primary d-sm-none btn-icon"
                    ...
                    <div class="card">
                        <div class="table-responsive">
                            <table class="table table-vcenter table-mobile-md card-table">
                                ...
                                <tbody>
                                    @forelse ($penyewas as $row)
                                        <tr>
                                            <td class="text-secondary align-text-top" data-label="No">
                                                {{ $loop->iteration + $penyewas->firstItem() - 1 }}
                                            </td>
                                            ...
                                            <td class="align-text-top">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end" style="">
                                                    <a class="dropdown-item" href="{{ route('penyewa.edit', $row->id) }}">
                                                        <i class="ti ti-edit icon text-secondary me-2"></i>
                                                        Edit
                                                    </a>
                                                    <a class="dropdown-item text-danger" href="#"
                                                        onclick="handleDelete(`{{ route('penyewa.destroy', $row->id) }}`)">
                        ...
                        <div class="card-footer d-flex justify-content-center align-items-center">
                            {{ $penyewas->onEachSide(1)->withQueryString()->withPath(request()->fullUrl())->links() }}
                        </div>
                    </div>
                </div>
